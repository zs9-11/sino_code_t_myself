...
#set(SDKTARGETSYSROOT "/opt/oecore-x86_64/sysroots/armv7at2hf-neon-oe-linux-gnueabi")
#set(OECORE_NATIVE_SYSROOT "/opt/oecore-x86_64/sysroots/x86_64-oesdk-linux")
#set(OECORE_TARGET_SYSROOT "${SDKTARGETSYSROOT}")
#9628
set(NEOWAY_CROSSTOOL_PATH "/home/sinognss/vendor/A70B_OPEN_LINUX_Q220_SDK_V3.33/tool/neoway-arm-oe-linux")
set(SDKTARGETSYSROOT "${NEOWAY_CROSSTOOL_PATH}/sysroots/armv7ahf-neon-oe-linux-gnueabi")
set(OECORE_NATIVE_SYSROOT "${NEOWAY_CROSSTOOL_PATH}/sysroots/x86_64-oesdk-linux")
set(OECORE_TARGET_SYSROOT "${SDKTARGETSYSROOT}")
...
set(LIBRARY_OUTPUT_PATH "${PROJECT_SOURCE_DIR}/Output/lib/qcom_9628")
